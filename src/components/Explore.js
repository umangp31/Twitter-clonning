    ...
    const handleActiveTab = (e) => {
        ...
        for (let i = 0; i < tab_list.length; i++) {
            if (tab_list[i].classList.contains("active_tab")) {
                ...
                if (active_line_list[i].classList.contains("active_line")) {
                    active_line_list[i].classList.remove("active_line");
