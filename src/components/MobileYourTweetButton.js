...
function MobileYourTweetButton({ userTwitted }) {
          ...
          <div className="Yourtweet_Container MobileModal">
            <div className="YourTweetMobileHeader">
              <div
                ...
                onClick={() => setIsYourTweetOpen(false)}
              >
                <BackArrowIcon />
              </div>
              <button
            ...
            <div className="Write_Tweet ">
              ...
              <div className="YourTweet_Form MobileDivider">
                ...
                <textarea
                  ...
                  rows="2"
                  draggable="false"
                  className="YourTweet_TweetText MT"
                  value={Tweettext}
                ...
                <div className="YourTweet_TweetReplyAcces">
                  ...
                  <span className={Tweettext.length > 250 ? "Alert" : ""}>
                    {Tweettext.length < 250 ? `${Tweettext.length}` : ""}
