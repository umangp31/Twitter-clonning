...
function MobileSideBar({ isOpen, setIsOpen }) {
  return (
    <div
      className="MobileSidebar_BackDrop"
      onClick={() => setIsOpen(false)}
      style={{ left: isOpen ? "0" : "-100%" }}
    >
      <div className="MobileSideBar_COntainer" style={{zIndex:"500"}}>
        ...
        <div className="menu-list">
          <ul className="link-wrapper-mobile">
            <li>
              <Link to="profile">
                <svg
                  height="30px"
                ...
                <h3 className="menu_list_option">Profile</h3>
              </Link>
            </li>
            <li>
              <Link to="/">
                ...
                <h3 className="menu_list_option">Lists</h3>
              </Link>{" "}
            </li>
            <li>
              <Link to="/explore">
                ...
                <h3 className="menu_list_option">Topics</h3>
              </Link>
            </li>
            <li>
              <Link to="/bookmarks">
                ...
                <h3 className="menu_list_option">Bookmarks</h3>
              </Link>
            </li>
            <li>
              <Link to="messages">
                ...
                <h3 className="menu_list_option">Moments</h3>
              </Link>
            </li>
            <li>
              <Link to="/bookmarks">
                ...
                <h3 className="menu_list_option">Newsletters</h3>
              </Link>
            </li>
          </ul>
        </div>
