        ...
        <div className="Notifications_Container">
            <div className="Notifications_header">
                ...
                <div className='Notifications_tabs'>
                    <div className={isAllScreen ? "Notifications_tab_options active_tab" : "Notifications_tab_options"} onClick={handleActiveTab}>All </div>
                    <div className={isAllScreen ? "Notifications_tab_options" : "Notifications_tab_options active_tab"} onClick={handleActiveTab}>Mentions</div>
                </div>
            </div>
            {
                isLoading ?
